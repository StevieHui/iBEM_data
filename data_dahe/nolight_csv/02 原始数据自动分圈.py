...
# 配置：输入/输出路径与起始标签
INPUT_PATH = r"D:\陈熠辉备份\大三上\寒假科研\ibem_data\data_dahe\raw_csv\test_dahe_light_calibrated_label.csv"
OUTPUT_PATH = r"D:\陈熠辉备份\大三上\寒假科研\ibem_data\data_dahe\raw_csv\test_dahe_light_with_laps.csv"
START_LABEL = 1 
